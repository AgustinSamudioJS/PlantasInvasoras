...
public class Juego extends InterfaceJuego
{
	...
	Juego(){
		...
		proyectil=new Proyectil(layka.x,layka.y,100,100);
...
//				proyectil.moverAdelante();
			...
			entorno.escribirTexto("NIVEL:"+nivel, 710, 580);
			//COLISION CON AUTO
